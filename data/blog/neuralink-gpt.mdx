...
- **Books**: trivial, yes, but the concept of a [second brain](https://www.amazon.com/Building-Second-Brain-Organize-Potential/dp/1982167386) has existed well before computers. While pen and paper don’t inherently generate new content, writing things down has always been humanities advantage over every other animal. Imagine if humans had to relearn everything over and over again each generation — we’d barely be able to start a fire. Instead, no single person needs to re-learn anything beyond some marginal improvement from one generation to the next. Reading a book from a person you’ve never heard of and will never meet is just like GPT, you’re outsourcing and leveraging knowledge. A library is like having a thousand subject matter expects at your beck and call!
...
- **Notion**: the natural extension of a second brain. Notion’s superpower is not that it is a Markdown editor. That is trivial. Instead, it is that it creates a natural parking lot for the human brain — or often, many human brains together.
...
In other words, everything that we’ve created in the productivity space over the last 40 years has been a rudimentary version of either GPT and Neuralink this whole time — we just didn’t know it yet! The deeper point here is that these two axes represent the fundamental categories that humans strive for in their quest to improve productivity.