...
Over the weekend, I saw the claim: "Soon, the cost of making software will be zero." A bold claim (one where the word "soon" does a lot of heavy lifting), but I agree. In my own time spent coding, I can build things much faster than I used to. I could write many many blog posts on where AI actually is a value add (use it like a fancy linter!) and where it's not (raw code generation): https://www.youtube.com/watch?v=zGBhsZHjqkU.

I've always had a bit of a grudge against these "pundits" who make claims from afar about trends in AI and software — almost like the out of touch general sending troops into certain death, while never getting his hands dirty. 
...
2. AI inherently is a multiplier (not a summation) on human labor. What that means, in plain terms, is that someone (a human!) still needs to get up and do the damn thing! 
   ...
   2. It's a multiplier on your workrate and intellect. If the latter term is 0, the result is still 0!
