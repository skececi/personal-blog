...
Soon, the cost of making software will be zero. A bold claim (one where the word "soon" does a lot of heavy lifting). In my own time spent coding, I can build things much faster than I used to. 

I could write many many blog posts on where AI actually is a value add (use it like a fancy linter!) and where it's not (raw, unfettered code generation: https://www.youtube.com/watch?v=zGBhsZHjqkU). 
