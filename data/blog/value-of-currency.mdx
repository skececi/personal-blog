...
The value of a currency exists solely as the market valuation of the collective effort that has been taken through any variety of means to make it legitimate. This effort can positively and negatively affect that valuation (as the market identifies forces that positive and negative forces).

Examples (along the spectrum of value):
...
Some tech savvy people are interested and figure it out. The “collective effort” of this token is the value of my service minus the barriers to The value is very low.
    ...
    But the barriers are lower due to the value (work, effort) that many crypto evangelists, marketers, and developers have added universally.
...
This is true (minus the global adjective). But it makes no statement on value.
...
But the value of this currency is simply a reflection of the value that myself and this massive organization of people has generated (both through technology but also through traditional means of marketing and sales). 

Crypto-currency doesn’t hold value in and of itself. 
It simply drastically lowers the barriers to entry 
(from needing: a military to instill fear of punishment, a legal system to identify counterfeiters, jails to punish said counterfeiters… to needing: a computer, an internet connection, social connectivity, and good execution).
...
---
As with anything I write - please let me know you're unfiltered thoughts. Email me: sam.kececi+blog@gmail.com