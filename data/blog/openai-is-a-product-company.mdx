...
So why did LinkedIn spiral into a tizzy and NVDA fall 15% and one week later? 
...
Why would you care about anything other than the car itself? The appearance, vibes, and "personality" of the car. And you'd be right to apply the same rationale for LLM models. 

If language models are all roughly the same on how well they can answer Math Olympiad questions and write code, why would you care about anything other than the UI and UX of the app through which you are interacting with the model? The appearance, vibes, and "personality" of the language model. 

---

The most viral posts about Deepseek weren't about the benchmarks or training methods. That stuff is cool, and it did get attention. But if you gather the most viral Tweets about Deepseek, they all fall into two categories:
1. People asking it about Tiananmen Square or Xi Jinping and watching it self-censor.
...
Get used to a world where a new "best" model will appear overnight and dethrone the previous frontruner on some combo of cost, speed, and quality.

Value is created across two diverging domains: the oil refinery business and the car manufacture business.
If you believe [competition is for losers](https://www.wsj.com/articles/peter-thiel-competition-is-for-losers-1410535536), this means that the way to generate value is to build the best car. 

Likewise, in the LLM world, value is created across the domains of AI training and inference, and consumer interaction with this AI.

To be clear, OpenAI plays in both. But the marginal value they create is because of the ChatGPT web app and any future consumer-facing product they ship. 
