...
- Consider the simple example of formatting a JSON string. Sheldon, who has been coding COBOL since 1874, writes an algorithm to parse it ehow he needs. He hosts a basic webservice and gives it some minimal resources – it's just running 5 lines of code. 
