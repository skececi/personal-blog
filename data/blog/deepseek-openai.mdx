...
To be clear, OpenAI plays in both. There is ChatGPT and the API. But the marginal value they create is solely because of the ChatGPT web app and any future consumer-facing product they ship. 
