...
If language models are all roughly the same on how well they can answer Math Olympiad questions and write code, why would you care about anything other than the UI and UX of the app through which you are interacting with the model, and the vibes and "personality" of the app.
...
Get used to a world where a new "best" model will appear overnight and dethrone the previous frontruner on some combo of cost, speed, and quality. What matters long term is building a way of interacting agnostically with models in a novel way.
